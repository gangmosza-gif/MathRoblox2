...
function Show-AuditExportConfirm {
    ...
    $dialog.Size = New-Object Drawing.Size(780,600)
    $dialog.BackColor = Get-AuditColor 'Canvas'
    $dialog.Font = New-AuditFont -Size 10

    $head = New-Object Windows.Forms.Panel
    $head.Dock = 'Top'; $head.Height = 72; $head.BackColor = Get-AuditColor 'Navy'
    $headText = New-AuditLabel -Text 'ตรวจแหล่งข้อมูลผลตรวจก่อนสร้างไฟล์ Word' -Size 13 -Style 'Bold' -ForeColor ([Drawing.Color]::White) -AutoSize
    $headText.Location = New-Object Drawing.Point(20,14)
    $headSub = New-AuditLabel -Text $OutputName -Size 9 -ForeColor ([Drawing.Color]::FromArgb(178,198,218)) -AutoSize
    $headSub.Location = New-Object Drawing.Point(20,44)
    ...
    $gridHost.Dock = 'Fill'; $gridHost.Padding = New-Object Windows.Forms.Padding(20,16,20,8)
    $gridHost.BackColor = Get-AuditColor 'Canvas'
    $gridHost.Controls.Add($grid)

    $foot = New-Object Windows.Forms.Panel
    $foot.Dock = 'Bottom'; $foot.Height = 82; $foot.BackColor = Get-AuditColor 'Canvas'
    $note = New-AuditLabel -Text 'AUTO_DRAFT คือค่าที่อ่านจาก Excel แต่ Mapping ยังไม่ยืนยัน กรุณาตรวจข้อความก่อนยืนยัน' -Size 9 -ForeColor (Get-AuditColor 'Warning') -AutoSize
    $note.Location = New-Object Drawing.Point(22,12)
    $cancel = New-AuditButton -Text 'ยกเลิก' -Width 130 -Kind 'Secondary'
    $cancel.Location = New-Object Drawing.Point(452,38); $cancel.DialogResult = 'No'
    $confirm = New-AuditButton -Text 'ยืนยันและ Export' -Width 180 -Kind 'Primary'
    $confirm.Location = New-Object Drawing.Point(596,38); $confirm.DialogResult = 'Yes'
...
function Start-AuditOnsiteUI {
    ...
    $form.Text = 'Audit Onsite Report - Phase 4.2 V0.8 UI'
    $form.StartPosition = 'CenterScreen'
    $form.Size = New-Object Drawing.Size(1320,880)
    $form.MinimumSize = New-Object Drawing.Size(1120,760)
    $form.BackColor = Get-AuditColor 'Canvas'
    $form.Font = New-AuditFont -Size 10
    ...
    [void]$root.RowStyles.Add((New-Object Windows.Forms.RowStyle([Windows.Forms.SizeType]::Absolute,84)))
    ...
    $headerTitle = New-AuditLabel -Text 'Audit Onsite Report' -Size 19 -Style 'Bold' -ForeColor ([Drawing.Color]::White) -AutoSize
    $headerTitle.Location = New-Object Drawing.Point(28,14)
    $headerSub = New-AuditLabel -Text 'สรุปรายงานผลการตรวจสอบสาขา - ทำงานออฟไลน์ ไม่แก้ไขไฟล์ Excel ต้นฉบับ' -Size 9.5 -ForeColor ([Drawing.Color]::FromArgb(170,192,214)) -AutoSize
    $headerSub.Location = New-Object Drawing.Point(30,52)
    $headerBadge = New-AuditBadge -Text 'PHASE 4.2 - TEST' -Kind 'Warning'
    $headerBadge.Location = New-Object Drawing.Point(1120,26)
    $header.Controls.AddRange(@($headerTitle,$headerSub,$headerBadge))
    $header.Add_Resize({ $headerBadge.Location = New-Object Drawing.Point(($header.Width - $headerBadge.Width - 28),26) }.GetNewClosure())
    ...
    [void]$body.ColumnStyles.Add((New-Object Windows.Forms.ColumnStyle([Windows.Forms.SizeType]::Absolute,262)))
    ...
    $sidebar.Padding = New-Object Windows.Forms.Padding(0,18,0,12)
    ...
    for ($i = 0; $i -lt 4; $i++) {
        ...
        $navButton.Size = New-Object Drawing.Size(262,62)
        $navButton.Margin = New-Object Windows.Forms.Padding(0,0,0,2)
        $navButton.FlatStyle = 'Flat'
        $navButton.FlatAppearance.BorderSize = 0
        $navButton.Font = New-AuditFont -Size 10
    ...
    $sideFoot.Dock = 'Bottom'; $sideFoot.Height = 150; $sideFoot.BackColor = Get-AuditColor 'NavyDark'
    $progressTitle = New-AuditLabel -Text 'ความคืบหน้า' -Size 9 -Style 'Bold' -ForeColor ([Drawing.Color]::FromArgb(150,174,198)) -AutoSize
    $progressTitle.Location = New-Object Drawing.Point(18,12)
    $progressFields = New-AuditLabel -Text '' -Size 9.5 -ForeColor ([Drawing.Color]::White)
    $progressFields.Location = New-Object Drawing.Point(18,38); $progressFields.Size = New-Object Drawing.Size(226,20)
    $progressResults = New-AuditLabel -Text '' -Size 9.5 -ForeColor ([Drawing.Color]::White)
    $progressResults.Location = New-Object Drawing.Point(18,60); $progressResults.Size = New-Object Drawing.Size(226,20)
    $progressTemplate = New-AuditLabel -Text '' -Size 9.5 -ForeColor ([Drawing.Color]::White)
    $progressTemplate.Location = New-Object Drawing.Point(18,82); $progressTemplate.Size = New-Object Drawing.Size(226,20)
    $progressBar = New-Object Windows.Forms.ProgressBar
    $progressBar.Location = New-Object Drawing.Point(18,114); $progressBar.Size = New-Object Drawing.Size(226,10)
    ...
    $statusText = New-AuditLabel -Text 'พร้อมใช้งาน' -Size 9.5 -ForeColor (Get-AuditColor 'TextMuted')
    $statusText.Location = New-Object Drawing.Point(16,9); $statusText.Size = New-Object Drawing.Size(820,22)
    $statusRight = New-AuditLabel -Text ('Config ' + [string]$Config.config_version + '   |   F5 = Scan   |   Ctrl+E = Export   |   Ctrl+1-4 = สลับหน้า') -Size 9 -ForeColor (Get-AuditColor 'TextMuted')
    $statusRight.TextAlign = 'MiddleRight'
    $statusRight.Size = New-Object Drawing.Size(460,22)
    $statusRight.Location = New-Object Drawing.Point(840,9)
    $statusBar.Controls.AddRange(@($statusText,$statusRight))
    $statusBar.Add_Resize({ $statusRight.Location = New-Object Drawing.Point(($statusBar.Width - $statusRight.Width - 16),9) }.GetNewClosure())
    ...
    $fieldToolbar.WrapContents = $false
    $fieldToolbar.Margin = New-Object Windows.Forms.Padding(0,0,0,14)
    $buttonSaveFix = New-AuditButton -Text 'บันทึกค่าที่ติ๊กจำไว้' -Width 190 -Kind 'Primary'
    $buttonClearFix = New-AuditButton -Text 'ล้างค่าจำทั้งหมด' -Width 170 -Kind 'Secondary'
    $buttonNewBranch = New-AuditButton -Text 'เริ่มสาขาใหม่' -Width 150 -Kind 'Secondary'
    $buttonFillToday = New-AuditButton -Text 'ใส่วันที่วันนี้ทุกช่องวันที่' -Width 210 -Kind 'Secondary'
    ...
    foreach ($group in $fieldGroups) {
        ...
        $grid.Dock = 'Top'; $grid.AutoSize = $true; $grid.AutoSizeMode = 'GrowAndShrink'; $grid.ColumnCount = 4
        [void]$grid.ColumnStyles.Add((New-Object Windows.Forms.ColumnStyle([Windows.Forms.SizeType]::Absolute,258)))
        [void]$grid.ColumnStyles.Add((New-Object Windows.Forms.ColumnStyle([Windows.Forms.SizeType]::Percent,100)))
        [void]$grid.ColumnStyles.Add((New-Object Windows.Forms.ColumnStyle([Windows.Forms.SizeType]::Absolute,80)))
        [void]$grid.ColumnStyles.Add((New-Object Windows.Forms.ColumnStyle([Windows.Forms.SizeType]::Absolute,96)))
        ...
        foreach ($definition in $group.Fields) {
            ...
            $label = New-AuditLabel -Text $labelText -Size 10 -ForeColor $(if ($isRequired) { Get-AuditColor 'Text' } else { Get-AuditColor 'TextMuted' })
            $label.TextAlign = 'MiddleLeft'
            $label.Size = New-Object Drawing.Size(250,30)
            $label.Margin = New-Object Windows.Forms.Padding(0,4,8,4)

            $textBox = New-Object Windows.Forms.TextBox
            $textBox.Font = New-AuditFont -Size 10.5
            $textBox.Anchor = 'Left, Right'
            $textBox.Height = 28
            $textBox.Margin = New-Object Windows.Forms.Padding(0,5,8,5)
            ...
            if ($dateKeys -contains $key) {
                $dateCell = New-AuditButton -Text 'วันนี้' -Width 72 -Height 28 -Kind 'Ghost'
                $dateCell.Font = New-AuditFont -Size 9
                $dateCell.Margin = New-Object Windows.Forms.Padding(0,5,8,5)
                $dateCell.Tag = $key
                ...
                $dateCell = New-AuditLabel -Text '' -Size 9
                $dateCell.Size = New-Object Drawing.Size(72,28)
            }

            $fixCheck = New-Object Windows.Forms.CheckBox
            $fixCheck.Text = 'จำค่า'
            $fixCheck.Font = New-AuditFont -Size 9.5
            $fixCheck.ForeColor = Get-AuditColor 'TextMuted'
            $fixCheck.Size = New-Object Drawing.Size(90,28)
            $fixCheck.Margin = New-Object Windows.Forms.Padding(0,7,0,5)
            $fixCheck.Tag = $key
    ...
    $excelLayout.Padding = New-Object Windows.Forms.Padding(24,20,24,20)
    ...
    [void]$excelLayout.RowStyles.Add((New-Object Windows.Forms.RowStyle([Windows.Forms.SizeType]::Absolute,58)))
    ...
    $excelToolbar.Dock = 'Fill'; $excelToolbar.WrapContents = $false
    $buttonChoose = New-AuditButton -Text 'เลือกไฟล์ Excel' -Width 170 -Kind 'Primary'
    $buttonRemove = New-AuditButton -Text 'นำออกจากรายการ' -Width 170 -Kind 'Secondary'
    $buttonClearFiles = New-AuditButton -Text 'ล้างรายการ' -Width 130 -Kind 'Secondary'
    $buttonScan = New-AuditButton -Text 'ตรวจและ Scan Mapping  (F5)' -Width 250 -Kind 'Primary'
    ...
    # การ์ดแบบยืดเต็มพื้นที่ ใช้กับตารางที่ต้องขยายตามหน้าต่าง
    $newFillCard = {
        param([string]$Title,[string]$Subtitle)
        $card = New-Object Windows.Forms.Panel
        $card.Dock = 'Fill'
        $card.BackColor = Get-AuditColor 'Surface'
        $card.Add_Paint({
            param($sender,$e)
        ...
        $cardBody = New-Object Windows.Forms.Panel
        $cardBody.Dock = 'Fill'
        $cardBody.BackColor = Get-AuditColor 'Surface'
        $cardBody.Padding = New-Object Windows.Forms.Padding(18,4,18,16)
        $cardHead = New-Object Windows.Forms.Panel
        $cardHead.Dock = 'Top'; $cardHead.Height = 62
        $cardHead.BackColor = Get-AuditColor 'Surface'
        $cardTitle = New-AuditLabel -Text $Title -Size 12 -Style 'Bold' -AutoSize
        $cardTitle.Location = New-Object Drawing.Point(20,14)
        $cardSubtitle = New-AuditLabel -Text $Subtitle -Size 9.5 -ForeColor (Get-AuditColor 'TextMuted') -AutoSize
        $cardSubtitle.Location = New-Object Drawing.Point(20,38)
        $cardHead.Controls.AddRange(@($cardTitle,$cardSubtitle))
        # เพิ่ม Body ก่อน Head เพื่อให้ Head อยู่บนสุดตามลำดับการ Dock ของ WinForms
        $card.Controls.Add($cardBody)
        $card.Controls.Add($cardHead)
        Add-Member -InputObject $card -MemberType NoteProperty -Name Surface -Value $cardBody
        return $card
    }

    $fileCard = & $newFillCard 'ไฟล์ที่เลือก' 'ลากไฟล์ .xlsx หรือ .xlsm มาวางในกรอบนี้ได้'
    ...
    $scanCard = & $newFillCard 'ผลการตรวจไฟล์และ Mapping' 'สถานะ Workbook แยกจากสถานะ Mapping ตามกฎเดิม'
    ...
    [void]$resultsLayout.RowStyles.Add((New-Object Windows.Forms.RowStyle([Windows.Forms.SizeType]::Absolute,60)))
    ...
    $searchBox.Font = New-AuditFont -Size 10
    $searchBox.BorderStyle = 'FixedSingle'
    $searchBox.Location = New-Object Drawing.Point(24,16)
    $searchBox.Size = New-Object Drawing.Size(320,28)
    $tips.SetToolTip($searchBox,'พิมพ์เลขข้อหรือคำในหัวข้อเพื่อกรองรายการ')
    $searchHint = New-AuditLabel -Text 'ค้นหาหัวข้อ' -Size 9 -ForeColor (Get-AuditColor 'TextMuted') -AutoSize
    $searchHint.Location = New-Object Drawing.Point(356,21)
    $resultsCounter = New-AuditLabel -Text '' -Size 10 -Style 'Bold' -ForeColor (Get-AuditColor 'Accent') -AutoSize
    $resultsCounter.Location = New-Object Drawing.Point(500,21)
    ...
    foreach ($mapping in $mappings) {
        ...
        $titleLabel = New-AuditLabel -Text ('ข้อ ' + $itemId + '   ' + [string]$mapping.title) -Size 11 -Style 'Bold' -AutoSize
        $titleLabel.Margin = New-Object Windows.Forms.Padding(0,3,14,6)
        ...
        $resultBox.Font = New-AuditFont -Size 10.5
        $resultBox.BorderStyle = 'FixedSingle'
        $resultBox.Height = 86
        $resultBox.Anchor = 'Left, Right'
        $resultBox.Margin = New-Object Windows.Forms.Padding(0,4,0,2)
    ...
    $checkFields = New-AuditLabel -Text '' -Size 10.5 -AutoSize
    $checkFields.Margin = New-Object Windows.Forms.Padding(0,2,0,4)
    $checkResults = New-AuditLabel -Text '' -Size 10.5 -AutoSize
    $checkResults.Margin = New-Object Windows.Forms.Padding(0,2,0,4)
    $checkTemplate = New-AuditLabel -Text '' -Size 10.5 -AutoSize
    $checkTemplate.Margin = New-Object Windows.Forms.Padding(0,2,0,4)
    ...
    $exportToolbar.WrapContents = $false
    $exportToolbar.Margin = New-Object Windows.Forms.Padding(0,12,0,0)
    $buttonCheckTemplate = New-AuditButton -Text 'ตรวจ Template และ Placeholder' -Width 260 -Kind 'Secondary'
    $buttonExport = New-AuditButton -Text 'Export Word  (Ctrl+E)' -Width 220 -Kind 'Primary'
    $buttonExport.Enabled = $false
    $buttonOpenOutput = New-AuditButton -Text 'เปิดโฟลเดอร์ Output' -Width 200 -Kind 'Secondary'
    ...
    $summaryGrid.Columns[0].Width = 60
    $summaryGrid.Columns[1].AutoSizeMode = 'Fill'
    $summaryGrid.Columns[2].Width = 150
    $summaryGrid.Columns[3].Width = 110
    $summaryGridHost = New-Object Windows.Forms.Panel
    $summaryGridHost.Height = 330
    ...
    $form.Add_Shown({ & $selectPage 0; & $refresh; $timer.Start() }.GetNewClosure())
    $form.Add_FormClosed({ $timer.Stop(); $timer.Dispose() }.GetNewClosure())

    & $writeLog 'เปิดโปรแกรม Phase 4.2 V0.8 UI'
    Write-AuditLog $AppRoot 'เปิด Phase 4.2 V0.8 UI'
    [void]$form.ShowDialog()
}

Export-ModuleMember -Function Start-AuditOnsiteUI,Get-AuditThaiDate

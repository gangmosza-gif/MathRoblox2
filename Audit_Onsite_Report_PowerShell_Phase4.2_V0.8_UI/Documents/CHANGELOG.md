...
- เพิ่ม AuditOnsite.Theme.psm1 เป็นชั้น Design System กลาง (สี ฟอนต์ ปุ่ม ป้ายสถานะ การ์ด ตาราง)
...
- คืนปุ่มล้างค่าจำทั้งหมดและปุ่มเริ่มสาขาใหม่ ตามข้อกำหนดใน Handoff
- เพิ่มปุ่มเติมวันที่แบบไทย ลากวางไฟล์ Excel ค้นหาหัวข้อผลตรวจ และคีย์ลัด
- เปลี่ยน Export Gate เป็นหน้าต่างยืนยันแบบตาราง
- แก้คำสั่งเปิด Explorer หลัง Export ที่ต่อสตริงผิดใน V0.7
- เลิกใช้ตัวแปรชื่อ host ที่ทับตัวแปรอัตโนมัติของ PowerShell
- ไม่แก้ไข Word Export Engine, Excel Module, Core Module, Config และ Template
